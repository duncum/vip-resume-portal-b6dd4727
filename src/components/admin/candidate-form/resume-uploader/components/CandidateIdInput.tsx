...
const CandidateIdInput = ({ 
  ...
  return (
    <div className="flex items-start flex-col space-y-1 pb-2 border-b border-grey-200">
      <div className="flex items-center space-x-2 w-full">
        <FileText className="h-5 w-5 text-gold" />
        <div className="flex-1">
          <Label className="text-sm">Candidate ID <span className="text-red-500">*</span></Label>
          <Input
            value={candidateId}
